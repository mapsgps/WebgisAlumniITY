<?php
$dataSpreadsheetUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQB_VzAmAlGFSvr7dJATzgmc4-JpG-p_t8x3GIxWTBfErX9v9BmsXNeZwRHGX4iF1DW1iyHOXQURZN6/pub?gid=108334107&single=true&output=csv";
...
//Convert ke geojson//
$json_dataalumniITYTK = json_encode($output_new, JSON_NUMERIC_CHECK);
echo $json_dataalumniITYTK;
